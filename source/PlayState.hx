	...
	override public function create()
	{
		...
		switch (SONG.song.toLowerCase())
		{
			...
			case 'fuzzy-distortion':
				dialogue = CoolUtil.coolTextFile(Paths.txt('fuzzy-distortion/fuzzy-distortionDialogue'));
			case 'thorns':
	...
	*/
	...
	override function beatHit()
	{
		...
		if (curSong.toLowerCase() == 'wocky' && curBeat % 2 == 0)
					...
					if (curSong.toLowerCase() == 'fuzzy-distortion' && curBeat % 2 == 0)
					{
					phillyCityLights.forEach(function(light:FlxSprite)
					{
						light.visible = false;
		...
		if (curSong.toLowerCase() == 'fuzzy-distortion' && camZooming && FlxG.camera.zoom < 1.35 && curBeat % 2 == 0)
		{
			FlxG.camera.zoom += 0.016;
			camHUD.zoom += 0.015;
		}
